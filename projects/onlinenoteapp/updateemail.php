...
//check if new email exists (if it is same as before)
...
//    $message .= "https://www.swing.offyoucode.co.uk/projects/onlinenoteapp/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
    $message .= "http://localhost/projects/onlinenoteapp/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
