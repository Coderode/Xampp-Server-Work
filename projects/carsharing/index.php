...
<html lang="en">
  <head>
    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
      ...
      <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyALFnVkXZpzKYsE6pMMkLuubUKiPT0WnpY"></script>
      <style>
  ...
  <body>
    <!--Navigation Bar-->  
    <?php
    if(isset($_SESSION["user_id"]) && $logout==0){
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
              <p>WebDevelopment Copyright &copy; <?php $today = date("Y"); echo $today?>.</p>
          </div>
      </div>
