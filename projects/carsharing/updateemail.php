...
//$message .= "https://swing.offyoucode.co.uk/projects/carsharing/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
$message .= "http://localhost/projects/carsharing/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
if(mail($newemail, 'Email Update for your Car sharing Account', $message, 'From:'.'sk9971krishna@gmail.com')){
