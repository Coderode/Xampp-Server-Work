...
//$message .= "https://swing.offyoucode.co.uk/projects/carsharing/activate.php?email=" . urlencode($email) . "&key=$activationKey";
$message .= "http://localhost/projects/carsharing/activate.php?email=" . urlencode($email) . "&key=$activationKey";
